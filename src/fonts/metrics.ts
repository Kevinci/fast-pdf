...
mapRange(0xc0, 0xc5, "A");
LATIN1_BASE[0xc7] = "C";
mapRange(0xc8, 0xcb, "E");
mapRange(0xcc, 0xcf, "I");
LATIN1_BASE[0xd0] = "D";
LATIN1_BASE[0xd1] = "N";
mapRange(0xd2, 0xd6, "O");
LATIN1_BASE[0xd7] = "+";
LATIN1_BASE[0xd8] = "O";
mapRange(0xd9, 0xdc, "U");
LATIN1_BASE[0xdd] = "Y";
LATIN1_BASE[0xde] = "P";
mapRange(0xe0, 0xe5, "a");
LATIN1_BASE[0xe7] = "c";
mapRange(0xe8, 0xeb, "e");
mapRange(0xec, 0xef, "i");
LATIN1_BASE[0xf0] = "o";
LATIN1_BASE[0xf1] = "n";
mapRange(0xf2, 0xf6, "o");
LATIN1_BASE[0xf7] = "+";
LATIN1_BASE[0xf8] = "o";
mapRange(0xf9, 0xfc, "u");
LATIN1_BASE[0xfd] = "y";
LATIN1_BASE[0xfe] = "p";
LATIN1_BASE[0xff] = "y";
LATIN1_BASE[0x9f] = "Y"; // Ÿ
LATIN1_BASE[0x8a] = "S";
LATIN1_BASE[0x9a] = "s"; // Š š
LATIN1_BASE[0x8e] = "Z";
LATIN1_BASE[0x9e] = "z"; // Ž ž
LATIN1_BASE[0xa1] = "!";
LATIN1_BASE[0xbf] = "?"; // ¡ ¿
...
export const METRICS = {
  ...
  "Helvetica-Bold": makeMetrics(
    HELVETICA_BOLD_ASCII,
    typographicExtras({
      euro: 556,
      ellipsis: 1000,
      bullet: 350,
  ...
  "Times-BoldItalic": makeMetrics(
    TIMES_BOLD_ITALIC_ASCII,
    typographicExtras({
      euro: 500,
      ellipsis: 1000,
      bullet: 350,
